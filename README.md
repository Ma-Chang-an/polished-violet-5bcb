...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/polished-violet-5bcb
```

A live public deployment of this template is available at [https://polished-violet-5bcb.templates.workers.dev](https://polished-violet-5bcb.templates.workers.dev)
